...
async def test_end_to_end_workflow():
    ...
    try:
        ...
        print("  ✅ Task analyzed (embedding generated)")
        ...
        print("  ✅ Context prepared for generation")
...
async def main():
    ...
    try:
        ...
        print(
            f"  🔧 OpenAI Fallback: {'✅' if results['openai'] else '❌' if results['openai'] is False else '⚠️ '}"
        )
