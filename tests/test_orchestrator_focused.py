...
from synndicate.core.orchestrator import (
    Orchestrator, OrchestratorResult, PlanningState, CodingState, 
    ReviewState, RevisionState, CompletionState, ErrorState
)
from synndicate.core.state_machine import StateContext, StateType
...
class TestQueryProcessing:
    ...
    async def test_process_query_with_specific_workflow(self, orchestrator):
        ...
        with patch.object(orchestrator, '_execute_pipeline') as mock_execute:
            ...
            mock_execute.assert_called_once_with(query, {'trace_id': mock_execute.call_args[0][1]['trace_id']}, "development")
...
class TestStateExecution:
    ...
    async def test_pipeline_execution(self, orchestrator):
        ...
        mock_pipeline_result.completed_stages = [MagicMock(stage_name="planner"), MagicMock(stage_name="coder")]
        mock_pipeline_result.stages = [MagicMock(stage_name="planner"), MagicMock(stage_name="coder")]
