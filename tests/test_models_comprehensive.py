...
from synndicate.models.interfaces import (
    ModelType, ModelFormat, ModelConfig, GenerationConfig, 
    ModelResponse, LanguageModel, EmbeddingModel
)
from synndicate.models.manager import ModelManager
from synndicate.models.providers import (
    LocalLlamaProvider, LocalBGEProvider, OpenAIProvider, LocalModelProvider
)
...
class TestModelManager:
    ...
    async def test_model_manager_load_language_model(self, model_manager):
        ...
        with patch('synndicate.models.providers.LocalModelProvider.create_language_model') as mock_create:
    ...
    async def test_model_manager_load_embedding_model(self, model_manager):
        ...
        # Mock the model creation
        with patch('synndicate.models.providers.LocalModelProvider.create_embedding_model') as mock_create:
...
class TestLocalLlamaProvider:
    ...
    @pytest.mark.asyncio
    async def test_local_llama_provider_load(self, mock_subprocess, mock_find_executable, mock_path_exists):
    ...
    @patch('subprocess.Popen')
    @pytest.mark.asyncio
    async def test_local_llama_provider_unload(self, mock_subprocess, mock_find_executable, mock_path_exists):
